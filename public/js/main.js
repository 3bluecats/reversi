    ...
    chat_room ='lobby';
        ...
        /* What do do when the server says someone has left the room */
        ...
        /*If the payload fails, display an alert with message*/    
        if(payload.result == 'fail') {
            alert(payload.message);
            return;
        }
        ...
        /* If someone leaves, animate all their content out */
        var dom_elements = $('.socket_'+payload.socket_id);
        ...
        var newHTML = '<p>' +payload.username+' has just left the room</p>';
        var newNode = $(newHTML);
        newNode.hide();
        $('#messages').prepend(newNode);
        newNode.slideDown(1000);
    ...
    function uninvite (who) {
        ...
        function game_start(who){
          ...
          socket.on('game_start_response',function(payload){
            ...
            /* If the payload fails, display an alert with this message*/
            ...
            /* If the payload succeeds, we add a message */
